...
export function SiteFooter({ commercial = false }: SiteFooterProps) {
  return (
    <footer>
      ...
      <div className="footer-bottom"><span>© 2026 Solara Cleaning Services</span><Link to="/privacy">Privacy Policy</Link><span>Insured · Detail obsessed · Locally loved</span></div>
    </footer>
  )
}
